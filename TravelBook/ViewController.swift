...
//  TravelBook
//
//  Created by Gizem Zorlu on 29.05.2023.
//
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    @objc func chooseLocation(gestureRecognizer: UILongPressGestureRecognizer) {
        ...
        if gestureRecognizer.state == .began {
            ...
            let touchedCoordinateds = self.mapView.convert(touchedPoint, toCoordinateFrom: self.mapView)
            
            choosenLatitude = touchedCoordinateds.latitude
            choosenLongitude = touchedCoordinateds.longitude
            
            let annotation = MKPointAnnotation()
            annotation.coordinate = touchedCoordinateds
